...
<template>
  <div class="relative flex min-h-svh w-full items-center justify-center p-6 md:p-10" style="
    ...
    <div class="flex flex-col items-center">
      ...
      <div v-if="authStore.user" class="text-center flex flex-col items-center gap-6">
